...
const Dshow2 = () => {
    ...
    const getRepairById = async () => {
        const response = await Axios.get(`http://localhost:3001/repair/${repair_durablearticles_Id}`);
    ...
    const update = async (e) => {
        e.preventDefault();
        try {
            await Axios.put(`http://localhost:3001/repair/${repair_durablearticles_Id}`, {
