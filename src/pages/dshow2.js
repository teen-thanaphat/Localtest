...
const Dshow2 = () => {
    ...
    const getOrderDurablearticlesById = async () => {
        const response = await Axios.get(`http://localhost:3001/order_durablearticles/${order_durablearticles_Id}`);
    ...
    const updateorderd = async (e) => {
        e.preventDefault();
        try {
            await Axios.put(`http://localhost:3001/order_durablearticles/${order_durablearticles_Id}`, {
